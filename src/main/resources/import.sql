...
INSERT INTO tb_atividade(nome, descricao, preco, categoria_id) VALUES ('Oficina Git Hub', 'Controle versões do seus projetos', 50.00, 2);

--Não coloquei o Z no final da data e hora, pois estava salvando no banco com o fuso horário errado.
--pensei que @Column(columnDefinition = "TIMESTAMP WITHOUT TIME ZONE") salvava o horário que foi enviado, ignorando o fuso horário.
